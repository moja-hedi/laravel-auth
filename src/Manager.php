...
namespace MojaHedi\Auth;

use MojaHedi\Auth\Contracts\Providers\JWT as JWTContract;
use MojaHedi\Auth\Exceptions\JWTException;
use MojaHedi\Auth\Exceptions\TokenBlacklistedException;
use MojaHedi\Auth\Support\CustomClaims;
...
class Manager
{
     ...
     * @return Payload
     *
     * @throws \MojaHedi\Auth\Exceptions\TokenBlacklistedException
     */
